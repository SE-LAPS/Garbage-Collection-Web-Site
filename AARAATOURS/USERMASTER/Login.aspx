...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <center>
        <table style="width: 433px; height: 370px; background-color: #FF9933; font-size: large; font-weight: bold;">
            ...
            <tr>
                <td colspan="2" align="center" style="height: 42px">Select To Now :&nbsp&nbsp
                    <asp:DropDownList ID="DropDownList_login" runat="server">   
                        <asp:ListItem>GTF_Members</asp:ListItem>
                        <asp:ListItem>Green_Captain</asp:ListItem>
                        <asp:ListItem>Web_Master </asp:ListItem>
                    </asp:DropDownList></td>
           </tr>
